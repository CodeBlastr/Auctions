 ...
 */
 	public function index() {
		...
		$this->paginate['contain']['AuctionBid'] = array('limit' => 1, 'order' => array('AuctionBid.amount' => 'DESC'));
 ...
 */
    public function add() {
        ...
        // if (CakePlugin::loaded('Categories')) {
        	// $this->set('categories', $this->Auction->Category->generateTreeList(array('Category.model' => 'Auction')));
		// }
 ...
 */
    public function view($id = null) {
    	...
    	// delete this too if we have the highest bid already
    	// usort($auction['AuctionBid'], function($a, $b) {
 ...
 */
    public function categories($parentId = null) {
		...
		$conditions = !empty($parentId) ? array('Category.parent_id' => $parentId, 'Category.model' => 'Auction') : array('Category.model' => 'Auction');
