<div class="auction add form clearfix">
	...
	<?php echo $this->Form->input('Auction.id'); ?>
	...
	<div class="span4 col-md-4"> 
		<fieldset>
			...
			<?php echo $this->Form->input('Auction.increment', array('label' => 'Reverse Auction Price Increment (0.00)', 'type' => 'number', 'step' => '0.01', 'min' => '0', 'max' => '99999999999')); ?>
