<div class="auction view media row-fluid" id="<?php echo __('auction%s', $auction['Auction']['id']); ?>" itemscope itemtype="http://schema.org/Auction">
	...
	<div class="item auction gallery media-object span6">
		<?php echo $this->Media->carousel('default', array('data' => $auction, 'width' => 800, 'height' => 600, 'alt' => $auction['Auction']['name'])); ?>
    </div>
